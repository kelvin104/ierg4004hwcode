...
abstract contract ERC20Interface {
    ...
    function balanceOf(address tokenOwner) public view virtual returns (uint16 balance);
    function allowance(address tokenOwner, address spender) public view virtual returns (uint16 remaining);
    function transfer(address to, uint16 tokens) public virtual returns (bool success);
    function approve(address spender, uint16 tokens) public virtual returns (bool success);
    function transferFrom(address from, address to, uint16 tokens) public virtual returns (bool success);

    // events 
    event Transfer(address indexed from, address indexed to, uint16 tokens);
    event Approval(address indexed tokenOwner, address indexed spender, uint16 tokens);
}
...
contract IERG4004Token is ERC20Interface {
    ...
    function balanceOf(address tokenOwner) public view override returns (uint16 balance) {
        return balances[tokenOwner];
    }
    
    // allowance can be queried as well
    function allowance(address tokenOwner, address spender) public view override returns (uint16 remaining) {
        return allowed[tokenOwner][spender];
    }
    
    // you can approve someone to spend limited tokens from your wallet 
    function approve(address spender, uint16 tokens) public override returns (bool success) {
    ...
    function transferFrom(address from, address to, uint16 tokens) public override returns (bool success) {
